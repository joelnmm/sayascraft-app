...
<div class="formbold-main-wrapper" >
    ...
    <div class="w-full">
        ...
        <form action="{{url('admin/store-category')}}" method="POST" enctype="multipart/form-data" class="formbold-chatbox-form">
        @csrf
            <div class="formbold-mb-5">
                ...
                @enderror
                <input type="text" name="type" id="type" placeholder="Product Name" class="formbold-form-input"/>
            </div>
            ...
            <div class="formbold-mb-5" >
                ...
                @error('name')
                    <div class="error">{{ $message }}</div>
                @enderror
                <input type="text" name="subtype" id="subtype" placeholder="Product Name" class="formbold-form-input"/>
            </div>
