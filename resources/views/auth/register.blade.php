                            ...
                            <x-jet-validation-errors class="mb-4" />
                                <form class="form-stl" action="{{route('register')}}" name="frm-login" method="POST" >
                                    ...
                                    <fieldset class="wrap-input">
                                        ...
                                        <input type="text" id="frm-reg-lname" name="name" placeholder="Your Name*" value="" required autofocus autocomplete="name">
                                    </fieldset>
                                    <fieldset class="wrap-input">
                                    ...
                                    <input type="submit" class="btn btn-sign" value="Register" name="register" style="background-color: black;">
