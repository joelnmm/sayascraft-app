  ...
  <section id="topbar" class="topbar d-flex align-items-center">
    <div class="container d-flex justify-content-center justify-content-md-between">
      <div class="contact-info d-flex align-items-center">
        ...
        <i class="bi bi-phone d-flex align-items-center ms-4"><span>+1 3104866870</span></i>
      </div>
    ...
    <div class="wrapper d-flex align-items-stretch">
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components mb-5">
              <li class="active">
                  <a href="{{ route('user.dashboard') }}"><span class="fa fa-tachometer mr-3"></span> Dashboard</a>
              </li>
              <li>
                  <a href="{{ route('user.orders')}}"><span class="fa fa-shopping-basket mr-3"></span> My Orders</a>
              </li>
              <li>
                  <a href="{{ route('user.settings') }}"><span class="fa fa-toggle-on mr-3"></span> Settings</a>
              </li>
            </ul>
...
@if(Cart::instance('cart')->count() > 0)
  @if(!Request::is('cart') && !Request::is('checkout'))
    <a href="/cart" class="cart-top d-flex align-items-center justify-content-center active"><i class="badge bi bi-cart-fill" value="{{Cart::instance('cart')->count()}}" style="margin-left:25px;"> </i></a>
  @endif
@endif
